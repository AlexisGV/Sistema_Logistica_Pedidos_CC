...
=============================================-->
<div class="modal fade" id="modalAddProductoPedido" data-backdrop="static">
    <!--=============================================
    FORMULARIO - AGREGAR PRODUCTO
    =============================================-->
    <form role="form" class="modal-dialog modal-dialog-centered modal-lg" id="formAgregarProductoPedido" method="post" enctype="multipart/form-data">
        <div class="modal-content">

            <!-- HEADER
            -------------------------------------------------- -->
            <div class="modal-header" style="border-top: #28a745 12px solid;">
                <h1 class="modal-title">Agregar nuevo producto a pedido "<span id="viewNumberPedido">10001</span>"</h1>
                <input type="hidden" name="idPedido" id="idNumberPedidoAddProd">
            ...
            <div class="modal-body" style="border-top: #28a745 1px solid;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea type="text" class="form-control" name="ingNomProductoPedido" id="ingNomProducto" placeholder="Titulo o descripción breve del producto" autocomplete="off" rows="1" required></textarea>
            ...
            <div class="modal-footer" style="border-top: #28a745 1px solid;">
                ...
                <button type="button" class="btn btn-success btnAñadirProductoPedido">Agregar producto</button>
            </div>
            <!-- FIN PIE DEL MODAL
            -------------------------------------------------- -->

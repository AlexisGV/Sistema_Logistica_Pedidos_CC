    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-success btnActualizarEstado" idPedido="<?php echo $value["Id_Pedido"] ?>" ordenEstado="<?php echo $ordenEstado?>" avanceEstado="<?php echo intval($value["Avance_Estado"])+10 ?>">En camioneta</button>
                    </div>
                </td>
            </tr>
        <?php

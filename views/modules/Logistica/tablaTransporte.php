                ...
                <td>
                    <div class="btn-group">
                        <?php if (intval($permisosRecoleccion["U"]) == 1) :  ?>
                            <button type="button" class="btn btn-sm bg-maroon btnActualizarEstado" idPedido="<?php echo $value["Id_Pedido"] ?>" ordenEstado="<?php echo $ordenEstado ?>" avanceEstado="<?php echo intval($value["Avance_Estado"]) + 10 ?>">Recolectar</button>
                        <?php endif; ?>
                    </div>
                </td>
            </tr>

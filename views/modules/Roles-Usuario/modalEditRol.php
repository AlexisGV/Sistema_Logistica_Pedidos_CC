...
<div class="modal fade" id="modalEditRol" tabindex="-1" data-backdrop="static">
    <form class="modal-dialog modal-dialog-centered" role="form" id="formEditarRol" method="post">
        <div class="modal-content">
            ...
            <div class="modal-body" style="border-top: #17A2B8 1px solid;">
                ...
                <div class="form-group">
                    <label for="editDescripcionRol">Descripcion del rol de usuario</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fas fa-info-circle"></i></div>
                        </div>
                        <textarea class="form-control editDescripcionRol" name="editDescripcionRol" id="editDescripcionRol" placeholder="Ingresa una descripción acerca de las funciones que realizará este tipo de usuario" autocomplete="off" rows="3" required></textarea>
                    </div>
                </div>
                <?php
